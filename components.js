function loadComponents() {
  ...
  loadComponent("explanation.html", "explanation");
  console.log("explanation.html import"); // Konsolenausgabe hinzufügen
  loadComponent("aboutus.html", "aboutus");
  console.log("aboutus.html import"); // Konsolenausgabe hinzufügen
